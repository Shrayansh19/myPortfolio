...
const greeting = {
  ...
  subTitle: emoji(
    "Full Stack Developer with expertise in JavaScript, React, Node.js, and Python. Proven track record in backend optimization, API development, and enhancing user experience. Passionate about leveraging technology to solve real-world problems and improve user satisfaction.🚀 "
  ),
  resumeLink:
